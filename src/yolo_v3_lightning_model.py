...
class YOLOv3Lightning(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        scheduler = OneCycleLR(optimizer, max_lr=1E-3, steps_per_epoch=len(self.train_dataloader()), epochs=EPOCHS,
                               pct_start=5 / EPOCHS, div_factor=100, three_phase=False, final_div_factor=100,
